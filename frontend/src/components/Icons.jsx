// Centralized SVG Icon Components for consistent design
// Replaces all emoji usage throughout the application
...
export const Icons = {
  ...
  // Status indicator dots (small)
  Online: ({ className = "w-3 h-3" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <circle cx="12" cy="12" r="8" />
    </svg>
  ),
  
  Offline: ({ className = "w-3 h-3" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
  ...
  // For severity colors in alerts
  AlertCritical: ({ className = "w-5 h-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <circle cx="12" cy="12" r="10" fill="#ef4444" />
      <path d="M12 8v4m0 4h.01" stroke="white" strokeWidth="2" strokeLinecap="round" fill="none" />
    </svg>
  ),
  ...
  AlertSuccess: ({ className = "w-5 h-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
